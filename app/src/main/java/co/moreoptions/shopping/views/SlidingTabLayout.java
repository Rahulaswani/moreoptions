...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void setOnMyTabClickListener(MyTabClickListener myTabClickListener){
        mMyTabClickListener = myTabClickListener;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            SimpleDraweeView appImage = null;
            ...
            if (mTabViewLayoutId != 0) {
                ...
                appImage = (SimpleDraweeView) tabView.findViewById(mTabViewImageId);
            }
     ...
     */
    public static interface MyTabClickListener {
